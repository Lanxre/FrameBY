...
export function useEmploymentRequests() {
	...
	const fetchRequests = async (
		...
		try {
			...
			const response = await $api<EmploymentResponse>(
				`/employment-requests${query}`,
				{
					method: "GET",
				},
			);
...
export function useMyOrganizationRequests() {
	...
	const fetchRequests = async () => {
		...
		try {
			const response = await $api<{ requests: EmploymentRequest[] }>(
				"/employment-requests/my-organization",
				{
					method: "GET",
				},
			);
...
export function useMyApplications() {
	...
	const fetchRequests = async () => {
		...
		try {
			const response = await $api<{ requests: EmploymentRequest[] }>(
				"/employment-requests/my-applications",
				{
					method: "GET",
				},
			);
...
export function useEmploymentStatuses() {
	...
	const fetchStatuses = async () => {
		...
		try {
			const response = await $api<{ statuses: EmploymentStatus[] }>(
				"/employment-requests/statuses",
				{
					method: "GET",
				},
			);
...
export function useParticipantStatuses() {
	...
	const fetchStatuses = async () => {
		...
		try {
			const response = await $api<{ statuses: ParticipantStatus[] }>(
				"/employment-requests/participant-statuses",
				{
					method: "GET",
				},
			);
